 ...
 * @author Rnd21
 */
public class ConfirmOfBuy extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("If you want to confirm the purchase,");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmOfBuy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
